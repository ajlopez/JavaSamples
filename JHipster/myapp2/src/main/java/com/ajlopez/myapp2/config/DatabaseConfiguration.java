package com.ajlopez.myapp2.config;

import com.ajlopez.myapp2.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.ajlopez.myapp2.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.ajlopez.myapp2.repository.search")
