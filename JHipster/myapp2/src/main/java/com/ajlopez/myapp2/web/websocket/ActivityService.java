package com.ajlopez.myapp2.web.websocket;

import com.ajlopez.myapp2.security.SecurityUtils;
import com.ajlopez.myapp2.web.websocket.dto.ActivityDTO;
...
import static com.ajlopez.myapp2.config.WebsocketConfiguration.IP_ADDRESS;
