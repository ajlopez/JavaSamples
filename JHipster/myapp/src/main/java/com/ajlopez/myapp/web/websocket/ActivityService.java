package com.ajlopez.myapp.web.websocket;

import com.ajlopez.myapp.security.SecurityUtils;
import com.ajlopez.myapp.web.websocket.dto.ActivityDTO;
...
import static com.ajlopez.myapp.config.WebsocketConfiguration.IP_ADDRESS;
